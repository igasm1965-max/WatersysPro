...
### Интерактивный просмотр документации
- **[docs/app/index.html](docs/app/index.html)** - Документация как отдельное mini-app
   - Запуск через backend: `http://localhost:3000/docs/`
   - Левое меню документов
